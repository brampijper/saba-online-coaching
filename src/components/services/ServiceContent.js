...
const ServiceContent = ({ service: {service, id} }) => {
    ...
    return (
        <>
            <div className={ service.darkMode ? "bg-s-purple pt-16 pb-32 text-white" : "" }>
                ...
                xl:max-w-screen-xl max-w-screen-lg px-6">
                    ...
                    <div className="flex flex-col space-y-12 md:flex-row md:space-y-0 lg:space-x-40 md:space-x-20">
                        ...
                        <div className={` ${bgColor} h-36 w-100 lg:h-48 lg:w-48 rounded border-2 border-s-purple flex justify-center items-center`}><span className="text-xl lg:text-2xl font-bold text-s-purple word-spacing-wide">{service.price}$ p/session</span></div>
                        <div className={` ${bgColor} h-36 w-100 lg:h-48 lg:w-48 rounded border-2 border-s-purple flex justify-center items-center`}><span className="text-xl lg:text-2xl font-bold text-s-purple word-spacing-wide">{service.program_duration} days</span></div>
                    </div>
